...
const WORDS = ["Bohdan Danylenko", "Let's create some project together"];
const TECH_STACK = ["React", "Javascript", "HTML", "CSS", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/danylenko2109" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/bohdan-danilenko-660453326/" },
  { icon: Instagram, link: "https://www.instagram.com/suyeomso" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/27018a0d-2075-4234-aeed-9606479dc01e/f4uTqf9aRQ.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
